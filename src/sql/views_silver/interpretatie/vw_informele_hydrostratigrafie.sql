-- View: s_bodemenondergrond.vw_informele_hydrostratigrafie_group_observations

-- DROP VIEW s_bodemenondergrond.vw_informele_hydrostratigrafie_group_observations;

CREATE OR REPLACE VIEW s_bodemenondergrond.vw_informele_hydrostratigrafie_group_observations
 AS
 WITH r AS (
         SELECT lip.permkey,
           ...
           FROM b_bodemenondergrond.tbl_interpretatie ti
             ...
             JOIN b_bodemenondergrond.tbl_informele_hydrostratigrafie tlb ON tlb.interpretatie_id = ti.interpretatie_id
        )
...
ALTER TABLE s_bodemenondergrond.vw_informele_hydrostratigrafie_group_observations
    OWNER TO postgres;

-- View: s_bodemenondergrond.vw_informele_hydrostratigrafie_group_observations_values

-- DROP VIEW s_bodemenondergrond.vw_informele_hydrostratigrafie_group_observations_values;

CREATE OR REPLACE VIEW s_bodemenondergrond.vw_informele_hydrostratigrafie_group_observations_values
 AS
 WITH r AS (
         SELECT lip.permkey,
            row_number() OVER (PARTITION BY lip.permkey ORDER BY tlb.van) AS rn,
...
ALTER TABLE s_bodemenondergrond.vw_informele_hydrostratigrafie_group_observations_values
    OWNER TO postgres;

-- View: s_bodemenondergrond.vw_informele_hydrostratigrafie_observation

-- DROP VIEW s_bodemenondergrond.vw_informele_hydrostratigrafie_observation;

CREATE OR REPLACE VIEW s_bodemenondergrond.vw_informele_hydrostratigrafie_observation
 AS
 WITH relevant_int AS (
         SELECT DISTINCT ti_1.interpretatie_id,
           ...
           FROM b_bodemenondergrond.tbl_interpretatie ti_1
             ...
             JOIN b_bodemenondergrond.tbl_informele_hydrostratigrafie tlb ON tlb.interpretatie_id = ti_1.interpretatie_id
        ), ti AS (
 ...
 SELECT DISTINCT 'interp:'::text || ti.relkey AS "@id",
    ...
    'cl-interpretatie:informeleHydrostratigrafie'::text AS "dcterms:type",
    '"Informele hydrostratigrafie op locatie van boorgat '::text || boring.permkey AS "rdfs:label",
    ti."sosa:resultTime",
...
ALTER TABLE s_bodemenondergrond.vw_informele_hydrostratigrafie_observation
    OWNER TO postgres;

-- View: s_bodemenondergrond.vw_informele_hydrostratigrafie_observation_group

-- DROP VIEW s_bodemenondergrond.vw_informele_hydrostratigrafie_observation_group;

CREATE OR REPLACE VIEW s_bodemenondergrond.vw_informele_hydrostratigrafie_observation_group
 AS
 WITH relevant_int AS (
 ...
 SELECT 'observationgroup:interp'::text || observations.relkey AS "@id",
    ...
    '"Observation group Informele hydrostratigrafie op locatie van boorgat'::text || boring.permkey AS "rdfs:label",
...
ALTER TABLE s_bodemenondergrond.vw_informele_hydrostratigrafie_observation_group
    OWNER TO postgres;

-- View: s_bodemenondergrond.vw_informele_hydrostratigrafie_observation_list

-- DROP VIEW s_bodemenondergrond.vw_informele_hydrostratigrafie_observation_list;

CREATE OR REPLACE VIEW s_bodemenondergrond.vw_informele_hydrostratigrafie_observation_list
 AS
 WITH counter AS (
         SELECT lip.permkey,
...
ALTER TABLE s_bodemenondergrond.vw_informele_hydrostratigrafie_observation_list
    OWNER TO postgres;
