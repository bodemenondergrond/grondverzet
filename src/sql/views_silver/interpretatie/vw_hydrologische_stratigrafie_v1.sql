-- View: s_bodemenondergrond.vw_hydrogeologische_stratigrafie_v1_group_observations

-- DROP VIEW s_bodemenondergrond.vw_hydrogeologische_stratigrafie_v1_group_observations;

CREATE OR REPLACE VIEW s_bodemenondergrond.vw_hydrogeologische_stratigrafie_v1_group_observations
 AS
 WITH r AS (
         SELECT lip.permkey,
            row_number() OVER (PARTITION BY lip.permkey ORDER BY tlb.van) AS rn,
            'cl-aquiferv1:'::text || tlb.aquifer AS "bodemenondergrond:aquiferV1",
 ...
 SELECT (('observation:interp'::text || permkey) || '-'::text) || rn AS "@id",
    ...
    'dataset:hydrogeologischeStratigrafieV1'::text AS "qb:dataSet",
    'cl-interpretatie:hydrogeologischeStratigrafieV1'::text AS "dcterms:type",
    ...
    "bodemenondergrond:aquiferV1",
    "bodemenondergrond:hydrotype"
   FROM r;

ALTER TABLE s_bodemenondergrond.vw_hydrogeologische_stratigrafie_v1_group_observations
    OWNER TO postgres;

-- View: s_bodemenondergrond.vw_hydrogeologische_stratigrafie_v1_group_observations_values

-- DROP VIEW s_bodemenondergrond.vw_hydrogeologische_stratigrafie_v1_group_observations_values;

CREATE OR REPLACE VIEW s_bodemenondergrond.vw_hydrogeologische_stratigrafie_v1_group_observations_values
 AS
 WITH r AS (
         SELECT lip.permkey,
            row_number() OVER (PARTITION BY lip.permkey ORDER BY tlb.van) AS rn,
...
ALTER TABLE s_bodemenondergrond.vw_hydrogeologische_stratigrafie_v1_group_observations_values
    OWNER TO postgres;

-- View: s_bodemenondergrond.vw_hydrogeologische_stratigrafie_v1_observation

-- DROP VIEW s_bodemenondergrond.vw_hydrogeologische_stratigrafie_v1_observation;

CREATE OR REPLACE VIEW s_bodemenondergrond.vw_hydrogeologische_stratigrafie_v1_observation
 AS
 WITH relevant_int AS (
         SELECT DISTINCT ti_1.interpretatie_id,
           ...
           FROM b_bodemenondergrond.tbl_interpretatie ti_1
             ...
             JOIN b_bodemenondergrond.tbl_hydrogeologische_interpretatie tlb ON tlb.interpretatie_id = ti_1.interpretatie_id
        ), ti AS (
 ...
 SELECT DISTINCT 'interp:'::text || ti.relkey AS "@id",
    ...
    'cl-interpretatie:hydrogeologischeStratigrafieV1'::text AS "dcterms:type",
    '"hydrogeologische stratigrafie (HCOVv1) op locatie van boorgat '::text || boring.permkey AS "rdfs:label",
    ti."sosa:resultTime",
...
ALTER TABLE s_bodemenondergrond.vw_hydrogeologische_stratigrafie_v1_observation
    OWNER TO postgres;

-- View: s_bodemenondergrond.vw_hydrogeologische_stratigrafie_v1_observation_group

-- DROP VIEW s_bodemenondergrond.vw_hydrogeologische_stratigrafie_v1_observation_group;

CREATE OR REPLACE VIEW s_bodemenondergrond.vw_hydrogeologische_stratigrafie_v1_observation_group
 AS
 WITH relevant_int AS (
 ...
 SELECT 'observationgroup:interp'::text || observations.relkey AS "@id",
    ...
    '"Observation group hydrogeologische stratigrafie (HCOVv1) op locatie van boorgat '::text || boring.permkey AS "rdfs:label",
...
ALTER TABLE s_bodemenondergrond.vw_hydrogeologische_stratigrafie_v1_observation_group
    OWNER TO postgres;

-- View: s_bodemenondergrond.vw_hydrogeologische_stratigrafie_v1_observation_list

-- DROP VIEW s_bodemenondergrond.vw_hydrogeologische_stratigrafie_v1_observation_list;

CREATE OR REPLACE VIEW s_bodemenondergrond.vw_hydrogeologische_stratigrafie_v1_observation_list
 AS
 WITH counter AS (
         SELECT lip.permkey,
...
ALTER TABLE s_bodemenondergrond.vw_hydrogeologische_stratigrafie_v1_observation_list
    OWNER TO postgres;
